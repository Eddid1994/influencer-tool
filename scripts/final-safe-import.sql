...
SELECT import_campaign_batch('ImmoScout24', 'eigenheimliebe', 'ig', 'story', '2025-01-29', NULL, NULL, false, false, 1.45, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'January', 2025, 'JT', NULL);
...
SELECT import_campaign_batch('Vonmählen', 'myhorsediary', 'ig', 'story', NULL, NULL, NULL, false, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2024, 'JT', NULL);
...
SELECT import_campaign_batch('TERRACanis', 'fraulein_flausenimkopf', NULL, NULL, NULL, NULL, NULL, false, false, 250.0, 10, NULL, 25.0, NULL, NULL, NULL, NULL, NULL, 2024, NULL, NULL);
...
- Geschirr Bella M
- Hundebademantel M
- Futterplatzset Keramik Weiß
- Kofferraumschutz gesteppt', 'July', 2025, 'DP', 'done');
...
-- Total campaigns imported: 724

-- Step 3: Clean up function after import
DROP FUNCTION IF EXISTS import_campaign_batch;

-- Step 4: Verify final counts
SELECT 'Total Campaigns' as metric, COUNT(*) as count FROM campaigns;
